...
class UserManagementTest {
    App app;
    AdminControllers adminProceduresObject;
    ...
    public UserManagementTest() {
        this.app = new App();
        this.adminProceduresObject = new AdminControllers();
    }
    ...
    public void i_navigate_to_the_page(String page) {
    	boolean exp = true;
        boolean real = adminProceduresObject.navigateToManagementPage();
        assertTrue(exp == real);
    }
    
    @When("I fill in the details for a new user")
    public void i_fill_in_the_details_for_a_new_user() {
        adminProceduresObject.fillUserDetails("John", "Doe", "johndoe@example.com", "JohnDoe", "password123", "Instructor");
        System.out.println("Filled in details for a new user.");
    }
    
    @When("I submit the form")
    public void i_submit_the_form() {
        adminProceduresObject.submitForm();
    ...
    public void the_new_user_account_should_be_created_successfully() {
        boolean isCreated = adminProceduresObject.verifyUserCreation("JohnDoe");
    ...
    public void the_user_should_no_longer_be_able_to_log_in() {
        boolean isDeactivated = adminProceduresObject.verifyUserDeactivation("ActiveUser");
    ...
    public void there_are_pending_instructor_applications() {
        boolean hasPending = adminProceduresObject.checkPendingApplications();
    ...
    public void i_approve_an_application() {
        adminProceduresObject.approveApplication("PendingInstructor");
    ...
    public void the_instructor_should_receive_an_approval_notification() {
        boolean notificationSent = adminProceduresObject.verifyNotification("PendingInstructor");
    ...
    public void their_account_should_become_active() {
        boolean isActive = adminProceduresObject.verifyAccountActivation("PendingInstructor");
    ...
    public void i_view_activity_reports() {
        adminProceduresObject.viewActivityReports();
    ...
    public void i_should_see_detailed_engagement_statistics_for_all_users() {
        boolean reportsLoaded = adminProceduresObject.verifyActivityReports();
