...
public class ProgramManagementForInstructorTest {

	@When("I create a new program with Title {string}, Duration {string}, Difficulty {string}, and Goals {string}")
	public void i_create_a_new_program_with_title_duration_difficulty_and_goals(String string, String string2, String string3, String string4) {
	...
	public void i_set_the_price_to(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
