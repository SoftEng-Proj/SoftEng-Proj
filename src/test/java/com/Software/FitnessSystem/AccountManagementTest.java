...
public class AccountManagementTest {
	...
	public void i_select_as_my_dietary_preference(String string) {
		...
		String acutal = AccountManagementControls.setDietaryPreferences(App.getClientsMap().get("John29Doe"), "", "");
	...
	public void i_enter_my_personal_details_including_age_and_fitness_goals(String string, String string2) {
		...
		String acutal = AccountManagementControls.createProfile("", App.getClientsMap().get("John29Doe"), "", "");
        assertEquals(expcted, acutal);
	}
	...
	public void i_update_my_age_to(String string) {
		...
		String acutal = AccountManagementControls.updatePersonalDetails(App.getClientsMap().get("John29Doe"), "", "");
        assertEquals(expcted, acutal);
	}
