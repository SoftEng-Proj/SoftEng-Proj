...
import com.software.fitness_system.basics.Admin;
...
public class LoadAndSaveEntities {
    ...
    public static void saveProgramSchedChangeToFile(Map<String, String> ProgramSchedChangeMap, String ProgramSchedChangeFile) {
        ...
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            objectMapper.writeValue(file, ProgramSchedChangeMap);
        } catch (IOException e) {
            System.err.println("Error saving Progress: " + e.getMessage());
        }
    }
    ...
    public static void loadProgramSchedChangeFromFile(Map<String, String> ProgramSchedChange, String ProgramSchedChangeFile) {
        ...
        try {
            ...
            Map<String, String> loadedInstructorTips = objectMapper.readValue(file, new TypeReference<>() {});
            ProgramSchedChange.putAll(loadedInstructorTips);
    ...
    public static void saveProgressMSGToFile(Map<String, String> ProgressMSGMap, String ProgressMSGFile) {
        ...
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            objectMapper.writeValue(file, ProgressMSGMap);
        } catch (IOException e) {
            System.err.println("Error saving Progress: " + e.getMessage());
        }
    }
